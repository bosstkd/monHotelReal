...
private String rechPart;

    public String getRechPart() {
        return rechPart;
    }

    public void setRechPart(String rechPart) {
        this.rechPart = rechPart;
    }
...
//------------------------------------------    
@EJB
MhPartPublicationBean beanPubPart;
List<MhPubParticulier> listPartPubAll;

    public List<MhPubParticulier> getListPartPubAll() {
        rechPart = raisonSociale;
        if(rechIndex.equals("htlRech")){
            
            if(rechPart.length() > 3){
                          listPartPubAll = beanPubPart.pubListPhrase(rechPart);
                    }else{
                          listPartPubAll = beanPubPart.pubListAll();
                    }
        }
    ...
    public void setListPartPubAll(List<MhPubParticulier> listPartPubAll) {
      ...
      public String positPart(MhPubParticulier pub){
